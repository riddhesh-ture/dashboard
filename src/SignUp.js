...
const Card = styled(MuiCard)(({ theme }) => ({
  ...
  [theme.breakpoints.up('sm')]: {
    maxWidth: '450px', // Changed from width to maxWidth for consistency
  },
...
export default function SignUp(props) {
  ...
  const validateInputs = () => {
    ...
    const name = document.getElementById('name'); // Assuming 'name' is the ID for Full Name
      ...
      <SignUpContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          ...
          <Box
            ...
            noValidate // noValidate with manual validation
          ...
          >
            ...
            <FormControl>
              ...
              <TextField
                ...
                color={emailError ? 'error' : 'primary'} // Corrected color binding
              />
            </FormControl>
            <FormControl>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Typography sx={{ textAlign: 'center' }}>
              ...
              <RouterLink to="/signin" style={{ textDecoration: 'none' }}>
                <MuiLink component="span" variant="body2" sx={{ alignSelf: 'center' }}> {/* Use MUI Link for styling */}
                  Sign in
                </MuiLink>
              </RouterLink>
            </Typography>
